...
void WeakCheck( const Value& v, const Operation& op, long EH_DEFAULT_PARAM(max_iters, 20000000))
{
...
#ifdef EH_NO_DEFAULT_FUNCTION_TMPL_ARGS
template <class Value, class Operation>
void WeakCheck(const Value& v, const Operation& op)
{
    WeakCheck(v, op, 20000000L);
}
#endif
...
====================================================================================*/
template <class Value, class Operation>
void ConstCheck( const Value& v, const Operation& op, long EH_DEFAULT_PARAM(max_iters, 20000000))
{
    bool succeeded = false;
    bool failed = false;
...
#ifdef EH_NO_DEFAULT_FUNCTION_TMPL_ARGS
template <class Value, class Operation>
void ConstCheck( const Value& v, const Operation& op)
{
    ConstCheck(v, op, 20000000L);
}
#endif
...
====================================================================================*/
template <class Value, class Operation>
void StrongCheck( const Value& v, const Operation& op, long EH_DEFAULT_PARAM(max_iters, 20000000))
{
    bool succeeded = false;
    bool failed = false;
